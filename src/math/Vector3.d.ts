import { Vector3, VectorXZ, Direction, RGB, Vector2 } from "@minecraft/server";
...
declare namespace Vec3 {
	 ...
	 */
	function fromVectorXZ(v: VectorXZ): Vector3;
	/**
	 ...
	 */
	function toVectorXZ(v: Vector3): VectorXZ;
	/**
	 ...
	 */
	function angle(u: Vector3, v: Vector3): number;
}
