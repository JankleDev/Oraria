...
((Vec32) => {
	...
	function toDirection(v) {
		const a = abs(v),
			max2 = Math.max(a.x, a.y, a.z);
		if (max2 === a.x) return v.x >= 0 ? Direction.East : Direction.West;
		else if (max2 === a.y) return v.y >= 0 ? Direction.Up : Direction.Down;
...
export { Mat2, Mat3, RandVec, Vec2, Vec3 };
